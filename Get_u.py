...
logo = render('Abdo', colors=['blue', 'red'], align='center')
print(logo)
...
def patrek():
    ...
    print(A+"""
     ...
     ==================================
||1/__سحب من متااعبهم_|2/__سحب  من متابعين  ||
||3/__سحب من منشور_|4/__فحص ايديات>>>>>> ||
||5/__رشق مباشر _____|6/__سحب ايدي منشور>>  ||
||7/__بوت سحب ايدي|8/__اسخراج سيزون عشوائي||
||9/__بوت صيد متحات انستا|10/__موقع رشق~~~||
||11/__موقع رشق لايكات|12/__تثبيت مكاتب ~~~||
||13/__بوت رشق متابعين|14/__صيد بينات ~~~~||
||15/__بوت رشق لايكات|×××××××××××××××××××
»»»»»»»»»»»»»»»»»»»♡♡»»»»»»»»»»»»»»»»»»»
«««««««««««««««««♕♕«««««««««««««««««««««
